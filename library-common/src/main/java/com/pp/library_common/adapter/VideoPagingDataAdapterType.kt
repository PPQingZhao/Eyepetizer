...
object VideoPagingDataAdapterType {
    ...
    fun type_follow_card(layoutInflater: LayoutInflater) = DefaultViewBindingItem<VideoBean.Item>(
        type_follow_card,
    ...
    fun type_video_small_card(layoutInflater: LayoutInflater) = DefaultViewBindingItem<VideoBean.Item>(
    ...
    fun type_auto_play_follow_card(layoutInflater: LayoutInflater) = DefaultViewBindingItem<VideoBean.Item>(
